...
def model(): 
    ...
    def model():
        ...
        phoneme_dictionary_file = 'model/pronunciation-dictionary.dict'
        language_model_file_path = (acoustic_parameters_directory, language_model_file, phoneme_dictionary_file) 
        ...
        with sr.Microphone() as source:
            ...
            print(f"Elapsed time for input: {elapsed_time:60.5460f} seconds")

        try:
            recognized_text = r.recognize_sphinx(audio, language_model_file_path)
            print(f"Recognized text: {recognized_text}")
            return recognized_text
        except sr.UnknownValueError:
            print("Recognition failed: audio not recognized")
            return "error"
...
def index ():
    ...
    return jsonify({"faultindex": faultindex})
